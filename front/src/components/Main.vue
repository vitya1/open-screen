    ...
    <div>
        ...
        <div class="three column center aligned ui grid strip-bottom">
            <div class="column step">
                <p>
                    1. Наш сервис сохраняет выбранную вами web-страницы в различных форматах (.png, .zip, .pdf).
                </p><br>
                <img src="@/assets/images/step1.png" alt="">
            </div>
            <div class="column step">
                <p>
                    2. Уникальный <b data-tooltip="«Отпечаток пальцев» файла, вычисленный с помощью специальной математической операции" data-position="top center">хеш</b> сохраненных
                    данных сохраняется в блокчейне.
                    Там он в безопасности.
                    <a href="/about" target="_blank">Почему это важно?</a>
                </p>
                <img src="@/assets/images/step2.png" alt="">
            </div>
            <div class="column step">
                <p>
                    3. У вас есть доказательства того, что именно было написано на странице (там может быть
                    электронный договор или другая важная для вас информация).
                </p>
